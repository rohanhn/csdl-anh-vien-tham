...
<header style="display: block; top: 0px;" id="header" class="clearfix">
  ...
  <section id="header-inner" class="clearfix"> 
    <!-- logo start -->
    <section id="logo"> <a href=""> <img src="../images/logo.png" alt="Logo"> </a> </section>
    <!-- #logo end --> 
      ...
      <nav id="nav">
       <ul style="display: none;" id="menu-menu" class="menu">
          ...
          <li id="" class="menu-item"><a href="#"><i class="icon-nav icon-envelope"></i>Liên hệ</a></li>
        	 <li id="" class="menu-item"><a href="#" onClick="if(confirm('Bạn có muốn thoát không?'))document.cuong.submit()"><i class="icon-nav icon-book"></i>Đăng Xuất</a><span><?php echo $_SESSION["tendangnhap"] ?></span>
          </li>
        </ul>
