   ...
   <div class="form-group">
    ...
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">VIEWING_ANGLE_ALONG</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="view_along"><?php echo $row["view_along"] ?></textarea>
      </div>
    </div>
     <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">VIEWING_ANGLE_ACROSS</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="view_across"  ><?php echo $row["view_across"] ?></textarea>
      </div>
    </div>
     <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">SATELLITE_INCIDENCE</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="incidence"  ><?php echo $row["incidence"] ?></textarea>
      </div>
    </div>
     <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">SATELLITE_AZIMUTH</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="azimuth"  ><?php echo $row["azimuth"] ?></textarea>
      </div>
    </div>
     <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">SUN_AZIMUTH</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="sun_azimuth"  ><?php echo $row["sun_azimuth"] ?></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">SUN_ELEVATION</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="sun_elevation"  ><?php echo $row["sun_elevation"] ?></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">REVOLUTION_NUMBER</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="revolution_number" ><?php echo $row["revolution_number"] ?></textarea>
      </div>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">File Report</label>
      <div class="col-sm-8">
        <a href="<?php  echo $row["file_report"] ?>"><?php  echo $row["file_report"] ?></a><input type="file" class="form-control" id="file_report" name="file_report" />
      </div>
    </div>
  <!---->
	<!---------------------->
