  ...
  <form action="bv_insert.php" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >
    ...
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Frame_row3</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="Corner3" name="frame_row3"  required="required"></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Frame_col3</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="Corner3" name="frame_col3"  required="required"></textarea>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Frame_row4</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="Corner4" name="frame_row4"  required="required"></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Frame_col4</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="Corner4" name="frame_col4"  required="required"></textarea>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Source ID</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="source_id"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Mission</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="mission"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Processing Level</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="processing_level"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Geo table</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="geo_table"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Hori_Type</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="hori_type"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">hori_code</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="hori_code"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">hori_name</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="hori_name"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Job ID</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="job_id"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Pro Info</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="pro_info"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Pro_type</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="pro_type"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Pro_name</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="pro_name"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Pro_url</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="pro_url"  ></textarea>
      </div>
    </div>
    <div class="form-group">
     <label class="control-label col-sm-2" for="ten_nhom">Pro_level</label>
      <div class="col-sm-8">
        <textarea type="text"  class="form-control" id="DatasetProducer" name="pro_level"  ></textarea>
      </div>
    </div>
    <div class="form-group">
